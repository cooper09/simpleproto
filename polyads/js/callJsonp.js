 function callTheJsonp()
            ...
            {	
              ...
              catch(an_exception) // alert for the users that don't have a javascript console
                {
                    ...
                    var current_ad = "http://sonyainc.net/polyads/ads/bogner-1.jpg"
			...
			function storeData( publisher, campaign, location, adNo, clickdate ) {

               // clickdate="testme";

				var url = "http://sonyainc.net/polyads/php/insert_data.php?publisher="+publisher+"&campaign="+campaign+"&location="+location+"&adNo="+adNo+"&clickdate="+clickdate;
                //var url = "http://sonyainc.net/polyads/php/insert_data.php?publisher=biged&campaign=cool&location=here&clickdate=test2";
				 // create a new script element
                var script = document.createElement('script');
                // set the src attribute to that url
                script.setAttribute('src', url);
			 ...
			 function parseResponse (resp) {
                ...
                {
					console.log(" data_Base response: "+ _resp.response );

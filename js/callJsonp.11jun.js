 function callTheJsonp()
			...
			function storeData( publisher, campaign, location ) {
				var url = "http://sonyainc.net/polyads/php/insert_data.php?publisher="+publisher+"&campaign="+campaign+"&location="+ location;
